...
class Neuron_WTA:
    ...
    def change_w(self, n, tnw):
        """Изменение весов нейрона-победителя по правилу Гроссберга (ввод пороговой системы с паузой)"""
        if self.kol_win >= tnw:
            pass
        else:
...
for i in range(len(x)):
    ...
    for l in range(10):
        ...
        neurons[ind_win].change_w(n, threshold_number_win)
